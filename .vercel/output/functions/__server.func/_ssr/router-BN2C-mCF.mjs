...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BN2C-mCF.js
...
var styles_default = "/assets/styles-DHLfwm_N.css";
var DESCRIPTION$1 = "Ciberseguridad, redes, IT/OT y ERP para PyMEs e industria en México. MAPOCA TELECOM. Contacto: Martín Porras, 440 184 8426.";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "keywords",
				content: "ciberseguridad PyMEs México, ciberseguridad industrial, segmentación IT/OT, SAP Business One, vCISO, MAPOCA TELECOM, Martín Porras, infraestructura de redes, Microsoft 365"
			},
			{
				name: "author",
...
function schemaJson() {
	const data = {
		...
		"@graph": [{
			...
			name: COMPANY,
			slogan: SLOGAN,
			description: "Firma mexicana de tecnología, infraestructura y ciberseguridad para microempresas, PyMEs y empresas industriales. Diseña, implementa, protege y administra la infraestructura tecnológica.",
			email: EMAIL,
...
var $$splitComponentImporter = () => import("./routes-DRdZwcW9.mjs");
var DESCRIPTION = "Ciberseguridad, redes, IT/OT y ERP para PyMEs e industria en México. MAPOCA TELECOM. Contacto: Martín Porras, 440 184 8426.";
...
//#endregion
export { workSheet as C, whatsappHref as S, models as _, DEFAULT_NOTE as a, specialized as b, PHONE_DISPLAY as c, SLOGAN as d, faqs as f, mailHref as g, lines as h, CONTACT_NAME as i, PHONE_TEL as l, lineById as m, Route$3 as n, EMAIL as o, heroFor as p, COMPANY as r, LEGAL as s, router_exports as t, RECOMMENDATION as u, pillars as v, steps as x, recommend as y };
